"""
Django settings for FreeWayBackEnd project.
...
SECRET_KEY = 'django-insecure-kt^e$@1zn=v26hphb)a+7_u%i!*e675szlv(6vcgyqh5%o(1br'
...
WSGI_APPLICATION = 'FreeWayBackEnd.wsgi.application'
...
AUTH_USER_MODEL = 'FreeWayAuth.Account'
